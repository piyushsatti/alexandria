...
> Build a candidate Alexandria knowledge graph using `docs/graph/README.md` and its existing harness. Read applicable repository instructions first and preserve unrelated edits.
>
