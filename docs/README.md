...
Use this page as the map for the product documentation.

| Document | Use it when you need to… |
|---|---|
| [Getting started](getting-started.md) | Turn a GitHub Knowledge checkout into a local MCP or remote service |
| [Release workflow](release-workflow.md) | Build, verify, replace, and roll back a release |
| [Repository layout](repository-layout.md) | Understand the Knowledge/product boundary and Foundry conventions |
