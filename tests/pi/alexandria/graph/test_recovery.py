...
from pi.alexandria.graph import generation, recovery
...
from tests.pi.alexandria.runtime.test_graph_access import builder, fixture
    ...
    def test_round_trip_selection_evidence_and_new_process(self):
        ...
        completed = subprocess.run(
            [
                ...
                "-B",
                "-m",
                "pi.alexandria.graph.generation",
                "status",
                "--store",
                str(self.target),
            ],
